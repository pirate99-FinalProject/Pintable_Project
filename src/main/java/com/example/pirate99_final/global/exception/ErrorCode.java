...
public enum ErrorCode {
    ...
    REVIEW_DELETE_ERROR(HttpStatus.BAD_REQUEST, "리뷰 삭제에 실패했습니다."),
    NOT_FOUND_REVIEW_ERROR(HttpStatus.BAD_REQUEST, "해당하는 리뷰가 없습니다."),
    NOT_FOUND_ID_ERROR(HttpStatus.BAD_REQUEST, "해당하는 ID가 없습니다."),
    NOT_FOUND_STORE_ERROR(HttpStatus.BAD_REQUEST, "해당하는 상호명이 없습니다."),

    NOT_FOUND_STORE_STATUS_ERROR(HttpStatus.BAD_REQUEST, "해당하는 상호 상태가 없습니다."),
    NOT_FOUND_USER_ERROR(HttpStatus.BAD_REQUEST, "해당하는 사용자를 찾을 수 없습니다."),
    DUPLICATE_USER_ERROR(HttpStatus.BAD_REQUEST, "이미 존재하는 회원입니다."),
    WRONG_PASSWORD_ERROR(HttpStatus.BAD_REQUEST, "잘못된 비밀번호입니다.");
